...
ActiveRecord::Schema[7.2].define(version: 2025_02_18_005731) do
  ...
  create_table "video_scenes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["scene_id"], name: "index_video_scenes_on_scene_id"
    t.index ["video_id"], name: "index_video_scenes_on_video_id"
  end
  ...
  add_foreign_key "video_scenes", "scenes"
  add_foreign_key "video_scenes", "videos"
